...
router.post('/', seguridadMultiTenant, validarEsquema(esquemaCrearMetodoPago, 'body'), controlador.crearMetodoPago);
...
router.put('/:id', seguridadMultiTenant, validarIds(['id']), validarEsquema(esquemaActualizarMetodoPago.omit({ id: true }), 'body'), controlador.actualizarMetodoPago);
