 ...
 * Specialized button for Google OAuth authentication with Google branding
 * 
 * @param {Object} props
 ...
 */
const GoogleLoginButton = ({ isLoading = false, onClick, className = '' }) => {
  const handleClick = () => {
    if (onClick) {
      onClick();
    } else {
      // Default behavior: redirect to Google OAuth endpoint
